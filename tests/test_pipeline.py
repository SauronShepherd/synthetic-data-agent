...
def approved_plan() -> GenerationPlan:
    return GenerationPlan(
        ...
        intended_use="qa", budgets={"max_rows": 2},
...
def test_pipeline_runs_all_gates_and_publishes() -> None:
    result = run_standalone(approved_plan(), row_count=2, dataset_id="d", dataset_version="v1", location="uc.t", actor="reviewer", unique_key="id")
