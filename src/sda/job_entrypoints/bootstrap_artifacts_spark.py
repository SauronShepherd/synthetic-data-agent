...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    _create_delta_table(
        ...
        args.registry_table,
        (
            "artifact_id", "artifact_type", "artifact_schema_version", "status",
            "tool_name", "tool_version", "strategy_version", "run_id", "environment",
            "created_at", "completed_at", "configuration_hash", "reuse_fingerprint",
            "content_checksum", "primary_location", "summary", "error_code",
            "error_message_safe", "related_locations_json", "source_references_json",
            "warnings_json", "input_artifact_ids_json",
        ),
    )
