"""Command-line interface for the Article 01 project shell."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="sda",
        description="Synthetic Data Agent project shell.",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.command == "hello":
        ...
        print("A governed synthetic-data project, built article by article.")
